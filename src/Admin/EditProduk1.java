...
public class EditProduk1 extends javax.swing.JDialog {
    ...
    private void rSButtonHover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover1ActionPerformed
        try {
            String kodeProdukText = txtNama.getText();
            if (!kodeProdukText.matches("\\d+")) {  // Cek apakah hanya angka
                System.err.println("Kode produk hanya boleh berisi angka.");
                return; // Hentikan jika kode produk tidak valid
            }
            int kp = Integer.parseInt(kodeProdukText); // Sekarang aman mengonversi ke angka
            ...
            int hj = 0;
            try {
                hj = Integer.parseInt(txtNama4.getText());
            } catch (NumberFormatException e) {
                System.err.println("Kesalahan format harga produk jual: " + e.getMessage());
                return; // Hentikan proses jika harga jual tidak valid
            }

            // Validasi harga beli
            int hb = 0;
            try {
                hb = Integer.parseInt(txtNama5.getText());
            } catch (NumberFormatException e) {
                System.err.println("Kesalahan format harga produk beli: " + e.getMessage());
                return; // Hentikan proses jika harga beli tidak valid
            }

            // Validasi stok
            int st = 0;
            try {
                st = Integer.parseInt(txtNama6.getText());
            } catch (NumberFormatException e) {
                System.err.println("Kesalahan format stok produk: " + e.getMessage());
                return; // Hentikan proses jika stok tidak valid
            }
            ...
            // Menyimpan ID dari produk yang dipilih
