...
//                    JOptionPane.showMessageDialog(this, "Data berhasil disimpan");
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        ...
        if (n != -1) {
            ...
            System.out.println("Kode Produk Mentah: " + kodeProdukStr);

            int kodeProduk = 0;
            if (kodeProdukStr != null && !kodeProdukStr.isEmpty()) {
                String[] parts = kodeProdukStr.split("-");
                if (parts.length > 0 && parts[0].trim().matches("\\d+")) {
                    kodeProduk = Integer.parseInt(parts[0].trim());
                } else {
                    System.err.println("Kode produk tidak valid.");
                    return; // Keluar dari metode jika kode tidak valid
                }
            } else {
                System.err.println("Kode produk kosong.");
                return; // Keluar dari metode jika kosong
            }
            ...
            System.err.println("Tidak ada baris yang dipilih.");
        }
